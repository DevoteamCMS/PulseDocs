...
Both paths grant Pulse the same read-only permissions - see each cloud's page for the exact roles and permissions required, and for the supporting cloud services the automated path can enable for you.
