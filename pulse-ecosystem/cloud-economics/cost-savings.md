...
Two bars side by side: **Estimated Estate Cost**, the cost of everything in scope for the last full month, and **Estimated Savings**, the total of the open recommendations. The distance between them is the point - the share of the bill the open recommendations would remove.
...
![The Optimization Options menu open on one resource, with alternative options grouped together and the risk marker beside the selection](../../assets/images/cloud-economics/cost-savings-options.png)
...
- The recommendation leaves the Active tab, and appears on Historical Recommendations with the state **Exempted**. Its saving is counted as exempted from then on.
...
Every recommendation is in one of four states:
...
| **Exempted** | Closed with **Exempt** - a saving deliberately not taken | Historical Recommendations |
